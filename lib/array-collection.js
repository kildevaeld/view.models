...
class ArrayCollection extends events_1.EventEmitter {
     ...
     */
    reset(a) {
        this.trigger(types_1.ModelEvents.BeforeReset, this[types_1.MetaKeys.Models]);
        let old = this[types_1.MetaKeys.Models];
        this[types_1.MetaKeys.Models] = a || [];
        old.forEach((m, i) => this.didRemoveItem(m, i));
        this[types_1.MetaKeys.Models].forEach((m, i) => this.didAddItem(m, i));
        this.trigger(types_1.ModelEvents.Reset, old, this[types_1.MetaKeys.Models]);
        return this;
    }
    filter(fn) {
